...
import { TestTube2, Search } from 'lucide-react';
  ...
  const handleSearch = async () => {
    ...
    try {
      const res = await authFetch(
        `${API_BASE_URL}/fetchpatreg?patientName=${encodeURIComponent(patientName)}`,
  ...
  return (
    <Box>
      ...
      <Box sx={{ display: 'flex', alignItems: 'center', gap: 1.5, mb: 3 }}>
        ...
        <Box>
          <Typography variant="h5" fontWeight={700} color="text.primary">Test Results</Typography>
          <Typography variant="caption" color="text.secondary">Search patients and view or enter test results</Typography>
        </Box>
      </Box>
