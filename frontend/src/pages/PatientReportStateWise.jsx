...
function PatientReportStateWise() {
  ...
  const fetchData = async () => {
    ...
    try {
      ...
      const res = await authFetch(`${API_BASE_URL}/patientReportStateWise?startDate=${s}&endDate=${e}`);
  ...
  const columns = [
    { field: 'Date',  headerName: 'Month', flex: 1, minWidth: 120 },
    { field: 'State', headerName: 'State', flex: 1, minWidth: 140 },
  ...
  return (
    <Box>
      <Box sx={{ display: 'flex', alignItems: 'center', gap: 1.5, mb: 3 }}>
        ...
        <Box>
          <Typography variant="h5" fontWeight={700} color="text.primary">Patient Report — State Wise</Typography>
          <Typography variant="caption" color="text.secondary">Patient count grouped by state and city for a date range</Typography>
        </Box>
      </Box>
