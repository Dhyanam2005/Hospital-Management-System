...
function DeptDocFees() {
  ...
  const fetchData = async () => {
    ...
    try {
      ...
      const res = await authFetch(`${API_BASE_URL}/deptDocFees?startDate=${s}&endDate=${e}`);
  ...
  const columns = [
    ...
    { field: 'Test Department', headerName: 'Department',      flex: 1, minWidth: 160 },
  ...
  return (
    <Box>
      <Box sx={{ display: 'flex', alignItems: 'center', gap: 1.5, mb: 3 }}>
        ...
        <Box>
          <Typography variant="h5" fontWeight={700} color="text.primary">Department Doctor Fees</Typography>
          <Typography variant="caption" color="text.secondary">Fee collected per department and doctor for a date range</Typography>
        </Box>
      </Box>
