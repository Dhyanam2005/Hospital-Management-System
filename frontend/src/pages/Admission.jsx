  ...
  const handleSearch = async () => {
    ...
    try {
      const res = await authFetch(
        `${API_BASE_URL}/admissionInPat?patientName=${encodeURIComponent(patientName)}`,
  ...
  return (
    <Box>
      ...
      <Box sx={{ display: 'flex', alignItems: 'center', gap: 1.5, mb: 3 }}>
        ...
        <Box>
          <Typography variant="h5" fontWeight={700} color="text.primary">Admission</Typography>
          <Typography variant="caption" color="text.secondary">Search and admit in-patients</Typography>
        </Box>
      </Box>
