  ...
  return (
    <Box>
      <Box sx={{ display: 'flex', alignItems: 'center', gap: 1.5, mb: 3 }}>
        ...
        <Box>
          <Typography variant="h5" fontWeight={700} color="text.primary">Patient Bills</Typography>
          <Typography variant="caption" color="text.secondary">Search patients to view their bill summary</Typography>
        </Box>
      </Box>
